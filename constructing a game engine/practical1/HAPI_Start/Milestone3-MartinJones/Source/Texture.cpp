...
//constructer
Texture::Texture(const std::string &filepath, int numberOfFramesX, int numberOfFramesY) : m_Filepath(filepath), 
m_NumberOfFramesX(numberOfFramesX), m_NumberOfFramesY(numberOfFramesY), m_FrameWidth(m_TextureWidth / numberOfFramesX), m_FrameHeight(m_TextureHeight / numberOfFramesY)
{
}
...
void Texture::renderTexture(const int &windowWidth, const int &windowHeight, const int &x, const int &y, const int frameNumber)
{
	...
	{
		renderTextureByPixel(windowWidth, windowWidth, x, y, frameNumber);
	}
}
